...
Vite serves on **http://localhost:5174** and proxies `/api` → `:8001`.
...
6. You see your own analysis (themes, register, lesson, essence) and the echoing memory below, with **shared themes highlighted in honey** on both cards
